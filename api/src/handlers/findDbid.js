...
const findDBid = async (id, dogDetalle) => {
    try {
        // Busca un perro con el ID proporcionado en la base de datos
        ...
        // Si se creó un nuevo perro, devuelve sus detalles en formato JSON
        if (created) {
            return newDog.toJSON();
        }
    } catch (error) {
        // En caso de error, lanza un error indicando el problema encontrado
